    ...
    public function getServerQueryv3()
    {
        ...
        else
        {
            ...
            foreach($data->option['players'] as $player)
            {
                ...
                {
                    $playerTableData .= "<td><b><a class='team-{$player['team']}' href='".route('player-detail',$playerNameStripped)."'>".str_limit($player['name'],20)."</b></a></td>";
                }
                else
                {
                    $playerTableData .= "<td><span class='team-{$player['team']}'>".str_limit($player['name'],20)."</span></td>";
                }
