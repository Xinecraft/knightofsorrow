...
class MainController extends Controller
{
    public function getIndex()
    {
        ...
        {
            $x = Cookie::make('seen_donation_infoxx','true',1,null,url());
            //$x = cookie('seen_donation_infoxx','true',1);
            setcookie('seen_donation_infoxx','true',1);
            //dd($x);
            dd(Cookie::get('seen_donation_infoxx'));
        }
        /*
